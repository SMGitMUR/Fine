<%@ Page Title="" Language="C#" MasterPageFile="~/admin.Master" AutoEventWireup="true" CodeBehind="AdminNumberDr.aspx.cs" Inherits="Fine.forms.AdminNumberDr" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script>
        ...
        $('.bar-chart').simpleChart({
            title: {
                text: 'Total Number Of Traffic Offences Per Driver',
                align: 'center'
            },
            type: 'bar',
            layout: {
