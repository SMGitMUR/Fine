...
namespace Fine.forms
{
    public partial class PoliceLogin : System.Web.UI.Page
    {
        ...
        protected void btnlogin_Click(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "select * from police where po_num=@unum and po_pass=@pass and po_status=@status";
            //create three parameterized query for the above select statement 
            cmd.Parameters.AddWithValue("@unum", txtUsername.Text);
            ...
            if (reader.HasRows)
            {
                if (reader.Read())
                {
                    ...
                    Session["unum"] = txtUsername.Text;
                    Session["po_id"] = reader["po_id"]; // use job line 67
                    Session["po_email"] = reader["po_email"];
                ...
                Response.Redirect("policepersonal.aspx");
            ...
            else
            {
                ...
                lblactstatus.Text = "Wrong Credentials Try again.";
            }
        }
