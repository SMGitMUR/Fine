<%@ Page Title="" Language="C#" MasterPageFile="~/admin.Master" AutoEventWireup="true" CodeBehind="freezepo.aspx.cs" Inherits="Fine.forms.freezepo" %>
        ...
        <div class="wrapper wrapper--w900">
            <div class="card card-6">
                <div class="card-heading">
                    <h2 class="title" style="color: black">Freeze Officer User</h2>
                </div>
                <div class="card-body">
                    <div class="form">
                        ...
                        <asp:Panel ID="freeze" Visible="true" CssClass="form-row" runat="server">
                            ...
                            <asp:Label ID="Label2" runat="server" Text="Officer Id:" AssociatedControlID="txtjsId"></asp:Label>
                            <br />
                            <asp:TextBox ID="txtjsId" runat="server" CssClass="input--style-6" Enabled="false" />

                            <br />
                            <asp:Label ID="Label3" runat="server" Text="Officer Firstname:" AssociatedControlID="txtfname"></asp:Label>
                            <br />
                            <asp:TextBox ID="txtfname" runat="server" CssClass="input--style-6" Enabled="false" />

                            <br />
                            <asp:Label ID="Label4" runat="server" Text="Officer Lastname:" AssociatedControlID="txtlname"></asp:Label>
                            <br />
                            <asp:TextBox ID="txtlname" runat="server" CssClass="input--style-6" Enabled="false" />


                            <br />
                            <asp:Label ID="Label5" runat="server" Text="Officer NIC:" AssociatedControlID="txtnic"></asp:Label>
                            <br />
                            <asp:TextBox ID="txtnic" runat="server" CssClass="input--style-6" Enabled="false" />

                            <br />
                            <asp:Label ID="Label6" runat="server" Text="Officer Badge Number:" AssociatedControlID="txtnum"></asp:Label>
                            <br />
                            <asp:TextBox ID="txtnum" runat="server" CssClass="input--style-6" Enabled="false" />
                            ...
                            <h2>
                                <asp:Label ID="lblMsg" ForeColor="red" runat="server" Text="" CssClass="textsuccess"></asp:Label></h2>
                        </asp:Panel>
                        ...
                        <asp:Panel ID="table" Visible="true" CssClass="form-row" runat="server">
                            <div class="table-responsive table-striped table-hover" style="width: 100%">
                                <asp:GridView ID="gvCatNames" DataKeyNames="po_id" AutoGenerateColumns="false" OnSelectedIndexChanged="gvCatNames_SelectedIndexChanged" runat="server">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="First Name">
                                            <ItemTemplate>
                                                <asp:Label ID="lblCatName" Text='<%#Eval("po_fname")%>' runat="server" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Last Name">
                                            <ItemTemplate>
                                                <asp:Label ID="lblCatName2" Text='<%#Eval("po_lname")%>' runat="server" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="UserName">
                                            <ItemTemplate>
                                                <asp:Label ID="lblCatName3" Text='<%#Eval("po_uname")%>' runat="server" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Badge Number">
                                            <ItemTemplate>
                                                <asp:Label ID="lblCatName5" Text='<%#Eval("po_num")%>' runat="server" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="NIC">
                                            <ItemTemplate>
                                                <asp:Label ID="lblCatName6" Text='<%#Eval("po_nic")%>' runat="server" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Status">
                                            <ItemTemplate>
                                                <asp:Label ID="lblCatName4" Text='<%#Eval("po_status")%>' runat="server" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
