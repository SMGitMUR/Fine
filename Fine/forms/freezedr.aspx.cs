...
{
    public partial class freezedr : System.Web.UI.Page
    {
        ...
        protected void gvCatNames_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            txtNIC.Text = ((Label)gvCatNames.SelectedRow.FindControl("lblCatName5")).Text;
            txtlic.Text = ((Label)gvCatNames.SelectedRow.FindControl("lblCatName6")).Text;
        ...
        protected void btnBlock_Click(object sender, EventArgs e)
        {
            if (Page.IsValid) 
            {
                ...
                cmd.CommandText = "   update driver set dr_status = @sta where dr_id = @jid";
                ...
                if (IsUpdated)
                {
                    lblMsg.Text = CatName + " Driver Status updated successfully!";
