<%@ Page Title="" Language="C#" MasterPageFile="~/police.Master" AutoEventWireup="true" CodeBehind="NumberPolice.aspx.cs" Inherits="Fine.forms.NumberPolice" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script>
        ...
        $('.bar-chart').simpleChart({
            title: {
                text: 'Number Of Traffic Offences registered per month',
                align: 'center'
            },
            type: 'bar',
            layout: {
